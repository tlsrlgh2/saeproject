...
<body>
<%
	String pw = String.valueOf(session.getAttribute("managerPw"));
	...
	if(pw.equals(new_pwChk)){
		...
		out.println("location.href='../managerView/manager_Mypage_View.jsp'");
		out.println("</script>");
	}
	out.println("<script>");
	out.println("alert('비밀번호가 일치하지 않습니다.')");
	out.println("location.href='../managerView/managerMypageCheck.jsp'");
	out.println("</script>");
%>
</body>
</html>