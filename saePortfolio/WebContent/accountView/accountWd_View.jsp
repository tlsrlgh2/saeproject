...
<section>
	...
	<jsp:include page="../include/accountMyPageSideBar.jsp"/>
		...
		<div class="Content">
			<form action="../delete/amWidhdraw.jsp" method="POST" name="frm">
			<h2>탈퇴안내</h2>
			<p class="title">회원을 탈퇴하기전에 아래의 사항을 꼭 확인해주세요.</p>
			<br>
			<ul class="withdraw">
				<li>사용하고 계신 아이디(<span class="point"><%=session.getAttribute("accountId") %></span>)는 탈퇴할경우 재사용과 복구가 불가능합니다.</li>
			...
			<div class="accept">
				...
				<br>	
				<ul>
					<li>파트너사 회원 탈퇴의 경우 당사와의 계약이 만료된 경우에만 탈퇴해 주시기 바랍니다.</li>
					<li>탈퇴 후에는  <span class="point2"> 등록하신 상품의 경우 모두 삭제 처리됩니다.</span></li>		
				</ul>
				<br>
