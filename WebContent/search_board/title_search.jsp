...
<script type="text/javascript" src="../script/board.js?ver=2"></script>
</head>
<body>
		...
		%>
 		...
 		<fieldset>
 			...
 			<p>총 <%=count %> 개의 게시물이 있습니다.</p>
 						...
 						if(list.isEmpty()){%>
 							<div class="empty">
 								...
 								<p class="empty">게시판에 아직 등록된 댓글이 없습니다.</p>
 							</div>
 			...
 			<div class="board_btn">
	 			...
	 			<input type="button" value="게시글 작성" onclick="boardPermit()">
 			</div>
 			<div>
 				<form action="../search_board/search_select.jsp" method="POST" id="search">
	 				...
	 				<input type="submit" onclick="return search_chk()" value="검색" >
 				</form>
 			</div>
 		</fieldset>
 	</div>
