...
<body>
<%
	String pw = String.valueOf(session.getAttribute("accountPw"));
	...
	if(pw.equals(new_pwChk)){
		...
		out.println("location.href='../accountView/Mypage_View.jsp'");
		out.println("</script>");
	}
	out.println("<script>");
	out.println("alert('비밀번호가 일치하지 않습니다.')");
	out.println("location.href='../accountView/accountMypageCheck.jsp'");
	out.println("</script>");
%>
</body>
</html>