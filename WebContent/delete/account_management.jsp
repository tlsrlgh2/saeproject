...
<link type="text/css" rel="stylesheet" href="../css/management_choice.css?ver=5">
<link type="text/css" rel="stylesheet" href="../css/include.css">
<script type="text/javascript" src="../script/member_management.js?ver=7"></script>
</head>
<body>
		...
		<h2>회원 관리 페이지</h2>
			...
			<%
				...
				<%
					...
					<thead align="center">
						<th class="myBoardList">파트너사 아이디</th>
						<th class="myBoardList">파트너사 전화번호</th>
						<th class="myBoardList">회사이름</th>
